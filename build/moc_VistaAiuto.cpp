...
namespace {
struct qt_meta_stringdata_VistaAiuto_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_VistaAiuto_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_VistaAiuto_t qt_meta_stringdata_VistaAiuto = {
    {
        QT_MOC_LITERAL(0, 10),  // "VistaAiuto"
        QT_MOC_LITERAL(11, 13),  // "backRequested"
        QT_MOC_LITERAL(25, 0)   // ""
    },
    "VistaAiuto",
    "backRequested",
...
Q_CONSTINIT static const uint qt_meta_data_VistaAiuto[] = {
...
Q_CONSTINIT const QMetaObject VistaAiuto::staticMetaObject = { {
    ...
    qt_meta_stringdata_VistaAiuto.offsetsAndSizes,
    qt_meta_data_VistaAiuto,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_VistaAiuto_t,
        // Q_OBJECT / Q_GADGET
...
void *VistaAiuto::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VistaAiuto.stringdata0))
